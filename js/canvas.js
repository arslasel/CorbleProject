...
function onCanvasLoad() {
    ...
    */
    (function () {
        ...
        console.log(drawBoardContainer.getBoundingClientRect().width);
        console.log(drawBoardContainer.getBoundingClientRect().height);
        canvas.width = drawBoardContainer.getBoundingClientRect().width;
        canvas.height = drawBoardContainer.getBoundingClientRect().height;
